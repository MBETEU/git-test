...
@section('content')
<h1 class="text-3xl text-orange-500 mb-6 text-center">Se connecter</h1>
<form method="POST" action="{{ route('login') }}" class="w-full max-w-sm mx-auto rounded-lg border shadow-md p-5 mb-5">
    ...
    <button type="submit" class="bg-orange-500 text-white hover:bg-orange-700 transition ease-in-out duration-500 rounded-md shadow-md w-full block px-4 py-2 mt-3">Se connecter</button>
</form>
@endsection
